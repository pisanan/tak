...
var Layout = function () {
    ...
    var serInnerContentHeight = function(){
    	 var content = $('.page-content');
    	 var innercontent = $('.page-innercontent');
    	 var pagebar = $('.page-bar');
    	 var barHeight=pagebar.outerHeight();
    	 var height = content.innerHeight();
    	 innercontent.css('min-height', height-barHeight);
    	 innercontent.css('max-height', height-barHeight);
    }
